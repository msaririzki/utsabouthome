...
@section('content')
    <h1 class="heading">
        Selamat Datang di --{{ $programmer1['nama'] }} dan {{ $programmer1['nim'] }}-- Group
    </h1>
    ...
    <div class="grid-franchise">
        ...
        {{-- 4. gambar sate pak pong (kanan atas) --}}
        <div class="img-block">
            <img src="{{ asset('images/satepakpong.jpg.jpeg') }}" alt="Sate Pak Pong">
        </div>

        {{-- BARIS 2 --}}
        {{-- 5. card Gudeg Sagan (kiri bawah) --}}
        ...
        {{-- 7. gambar sushi --}}
        <div class="img-block">
            <img src="{{ asset('images/sushi.jpg') }}" alt="Sushi Story">
        </div>

        {{-- 8. card Sushi Cerita (kanan bawah) --}}
